    ...
    try:
        ...
        with app.app_context():
            ...
            with db.engine.connect() as connection:
                ...
                context = MigrationContext.configure(connection)  # Using connection instead of engine
                ...
                if current_rev is None:
                    ...
                    if current_rev != head_rev:
                        app.logger.info(f"Database needs upgrade. Current: {current_rev}, Head: {head_rev}")
                        command.upgrade(alembic_cfg, "head")
                        return True
                    else:
